...
#define OUR_STATIC_ROUTING ${19} // Make routing static from stage 2
...
#if ORCHESTRA_CONF_UNICAST_PERIOD == 7
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 8
#define ORCHESTRA_CONF_EBSF_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 55
#elif ORCHESTRA_CONF_UNICAST_PERIOD == 11
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 5
#define ORCHESTRA_CONF_EBSF_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 35
#elif ORCHESTRA_CONF_UNICAST_PERIOD == 15
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 4
#define ORCHESTRA_CONF_EBSF_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 25
#elif ORCHESTRA_CONF_UNICAST_PERIOD == 17
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 3
#define ORCHESTRA_CONF_EBSF_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 22
#elif ORCHESTRA_CONF_UNICAST_PERIOD == 19
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 3
#define ORCHESTRA_CONF_EBSF_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 20
#elif ORCHESTRA_CONF_UNICAST_PERIOD == 21
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 2
#define ORCHESTRA_CONF_EBSF_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 18
#elif ORCHESTRA_CONF_UNICAST_PERIOD == 26
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 2
#define ORCHESTRA_CONF_EBSF_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 15
#elif ORCHESTRA_CONF_UNICAST_PERIOD == 41
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 1
#define ORCHESTRA_CONF_EBSF_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 9
#elif ORCHESTRA_CONF_UNICAST_PERIOD == 57
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 1
#define ORCHESTRA_CONF_EBSF_PERIOD ORCHESTRA_CONF_UNICAST_PERIOD * 7
#else
#define ORCHESTRA_CONF_COMMON_SHARED_PERIOD ${18} * ORCHESTRA_CONF_UNICAST_PERIOD
#define ORCHESTRA_CONF_EBSF_PERIOD ${17} * ORCHESTRA_CONF_UNICAST_PERIOD
#endif
#else

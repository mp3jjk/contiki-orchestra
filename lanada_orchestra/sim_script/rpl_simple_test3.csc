...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      <interface_config>
        ...
        <x>7.730847570920982</x>
        <y>32.7998132652321</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-5.928915168616175</x>
        <y>72.8772542577698</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>21.940813921848324</x>
        <y>74.67013114000135</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.9328031207183539 0.0 0.0 0.9328031207183539 137.448692103846 115.29092407024672</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>

...
#define WITH_ORCHESTRA $ORCHESTRA
#endif /* WITH_ORCHESTRA */

#if WITH_ORACHESTRA == 0
#define TSCH_SCHEDULE_CONF_WITH_6TISCH_MINIMAL $MINIMAL // For 6TiSCH minimal configuration without orchestra
#endif

#if WITH_ORCHESTRA == 1
#define ORCHESTRA_CONF_UNICAST_PERIOD $SF
#elif TSCH_SCHEDULE_CONF_WITH_6TISCH_MINIMAL == 1
#define TSCH_SCHEDULE_CONF_DEFAULT_LENGTH $SF
#endif
